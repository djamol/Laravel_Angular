...
#base {
    ...
    <body >
        <svg viewBox="0 0 1400 1080" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="base">
              <g onclick="window.location.href = '/home';" filter="url(#flShadow)"><rect id="btnBase" x="418.117" y="460.55" width="563.765" height="158.899" rx="27" fill="#F1F3FF" /></g>
                <text id="txtSend" fill="#291D89" xml:space="preserve" style="white-space: pre" font-family="Roboto" font-size="50" font-weight="bold" letter-spacing="0.06em"><tspan x="679.379" y="568.027">Get Started</tspan></text>
